...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			ascension.Table:      ascension.ValidColumn,
			attribute.Table:      attribute.ValidColumn,
			class.Table:          class.ValidColumn,
			moralalignment.Table: moralalignment.ValidColumn,
			orderalignment.Table: orderalignment.ValidColumn,
			servant.Table:        servant.ValidColumn,
