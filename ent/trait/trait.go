...
const (
	...
	Table = "traits"
	// ServantsTable is the table that holds the servants relation/edge. The primary key declared below.
	ServantsTable = "trait_servants"
...
var (
	// ServantsPrimaryKey and ServantsColumn2 are the table columns denoting the
	// primary key for the servants relation (M2M).
	ServantsPrimaryKey = []string{"trait_id", "servant_id"}
)
