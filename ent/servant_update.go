...
func (su *ServantUpdate) SetCollectionNo(i int) *ServantUpdate {
	su.mutation.ResetCollectionNo()
	su.mutation.SetCollectionNo(i)
	return su
}

// SetNillableCollectionNo sets the "collection_no" field if the given value is not nil.
func (su *ServantUpdate) SetNillableCollectionNo(i *int) *ServantUpdate {
	if i != nil {
		su.SetCollectionNo(*i)
	}
	return su
}

// AddCollectionNo adds i to the "collection_no" field.
func (su *ServantUpdate) AddCollectionNo(i int) *ServantUpdate {
	su.mutation.AddCollectionNo(i)
	return su
}
...
func (su *ServantUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.AddedCollectionNo(); ok {
		_spec.AddField(servant.FieldCollectionNo, field.TypeInt, value)
	}
...
// SetCollectionNo sets the "collection_no" field.
func (suo *ServantUpdateOne) SetCollectionNo(i int) *ServantUpdateOne {
	suo.mutation.ResetCollectionNo()
	suo.mutation.SetCollectionNo(i)
	return suo
}

// SetNillableCollectionNo sets the "collection_no" field if the given value is not nil.
func (suo *ServantUpdateOne) SetNillableCollectionNo(i *int) *ServantUpdateOne {
	if i != nil {
		suo.SetCollectionNo(*i)
	}
	return suo
}

// AddCollectionNo adds i to the "collection_no" field.
func (suo *ServantUpdateOne) AddCollectionNo(i int) *ServantUpdateOne {
	suo.mutation.AddCollectionNo(i)
	return suo
}
...
func (suo *ServantUpdateOne) sqlSave(ctx context.Context) (_node *Servant, err error) {
	...
	if value, ok := suo.mutation.AddedCollectionNo(); ok {
		_spec.AddField(servant.FieldCollectionNo, field.TypeInt, value)
	}
