...
const (
	// Label holds the string label denoting the moralalignment type in the database.
	...
	// Table holds the table name of the moralalignment in the database.
	Table = "moral_alignments"
	...
	AscensionsColumn = "moral_alignment_id"
)
